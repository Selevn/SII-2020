...
namespace In
{
	...
	struct IN //исходные данные
	{
		...
		enum { T = 1024, F = 2048, I = 4096, L = 256,C = 128, N = 64, D= 32, O=16, S = 0  }; //S - space t - допустимый символ F- недопустимый I- игнорировать, иначе заменить, C-comma, L - Single lexem
